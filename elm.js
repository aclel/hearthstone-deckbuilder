...
Elm.Common.Model.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var testCard = {cardId: "TEST123"
                  ,name: "Test Card"
                  ,cost: 0
                  ,img: "http://wow.zamimg.com/images/hearthstone/cards/enus/original/HERO_09.png"
                  ,maxCopies: 2
                  ,numCopies: 0};
   var Card = F6(function (a,b,c,d,e,f) {    return {cardId: a,name: b,cost: c,img: d,maxCopies: e,numCopies: f};});
...
Elm.CardList.Model.make = function (_elm) {
   "use strict";
   _elm.CardList = _elm.CardList || {};
   _elm.CardList.Model = _elm.CardList.Model || {};
   if (_elm.CardList.Model.values) return _elm.CardList.Model.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var initialModel = {cards: _U.list([]),message: "Initialising..."};
   var Model = F2(function (a,b) {    return {cards: a,message: b};});
   return _elm.CardList.Model.values = {_op: _op,initialModel: initialModel,Model: Model};
};
Elm.CardList = Elm.CardList || {};
Elm.CardList.Action = Elm.CardList.Action || {};
Elm.CardList.Action.make = function (_elm) {
   "use strict";
   _elm.CardList = _elm.CardList || {};
   _elm.CardList.Action = _elm.CardList.Action || {};
   if (_elm.CardList.Action.values) return _elm.CardList.Action.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var CardRemoved = function (a) {    return {ctor: "CardRemoved",_0: a};};
   var CardAdded = function (a) {    return {ctor: "CardAdded",_0: a};};
   ...
   var NoOp = {ctor: "NoOp"};
   return _elm.CardList.Action.values = {_op: _op
                                        ,NoOp: NoOp
                                        ,LoadList: LoadList
                                        ,ShowList: ShowList
...
Elm.Library.Util.make = function (_elm) {
   "use strict";
   _elm.Library = _elm.Library || {};
   _elm.Library.Util = _elm.Library.Util || {};
   if (_elm.Library.Util.values) return _elm.Library.Util.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var broadcast = F3(function (outputs,data,action) {
      return A2($Effects.map,$Basics.always(action),$Effects.batch(A2($List.map,$Effects.task,A2($List.map,A2($Basics.flip,$Signal.send,data),outputs))));
   });
   var actionEffect = function (action) {    return $Effects.task($Task.succeed(action));};
   return _elm.Library.Util.values = {_op: _op,actionEffect: actionEffect,broadcast: broadcast};
};
Elm.CardList = Elm.CardList || {};
Elm.CardList.Service = Elm.CardList.Service || {};
Elm.CardList.Service.make = function (_elm) {
   "use strict";
   _elm.CardList = _elm.CardList || {};
   _elm.CardList.Service = _elm.CardList.Service || {};
   if (_elm.CardList.Service.values) return _elm.CardList.Service.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $CardList$Model = Elm.CardList.Model.make(_elm),
   $Common$Model = Elm.Common.Model.make(_elm),
   ...
   var cardDecoder = A7($Json$Decode.object6,
   $Common$Model.Card,
   ...
   $Json$Decode.oneOf(_U.list([A2($Json$Decode._op[":="],"maxCopies",$Json$Decode.$int),$Json$Decode.succeed(2)])),
   $Json$Decode.oneOf(_U.list([A2($Json$Decode._op[":="],"numCopies",$Json$Decode.$int),$Json$Decode.succeed(0)])));
...
Elm.CardList = Elm.CardList || {};
Elm.CardList.Update = Elm.CardList.Update || {};
Elm.CardList.Update.make = function (_elm) {
   "use strict";
   _elm.CardList = _elm.CardList || {};
   _elm.CardList.Update = _elm.CardList.Update || {};
   if (_elm.CardList.Update.values) return _elm.CardList.Update.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
...
Elm.CardList.View.make = function (_elm) {
   "use strict";
   _elm.CardList = _elm.CardList || {};
   _elm.CardList.View = _elm.CardList.View || {};
   if (_elm.CardList.View.values) return _elm.CardList.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $CardList$Action = Elm.CardList.Action.make(_elm),
   $CardList$Model = Elm.CardList.Model.make(_elm),
...
Elm.CardList = Elm.CardList || {};
Elm.CardList.Feature = Elm.CardList.Feature || {};
Elm.CardList.Feature.make = function (_elm) {
   "use strict";
   _elm.CardList = _elm.CardList || {};
   _elm.CardList.Feature = _elm.CardList.Feature || {};
   if (_elm.CardList.Feature.values) return _elm.CardList.Feature.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $CardList$Action = Elm.CardList.Action.make(_elm),
   $CardList$Model = Elm.CardList.Model.make(_elm),
   $CardList$Service = Elm.CardList.Service.make(_elm),
   $CardList$Update = Elm.CardList.Update.make(_elm),
...
Elm.Deck.Action.make = function (_elm) {
   ...
   var CardRemoved = function (a) {    return {ctor: "CardRemoved",_0: a};};
   var CardAdded = function (a) {    return {ctor: "CardAdded",_0: a};};
   var RemoveCard = function (a) {    return {ctor: "RemoveCard",_0: a};};
   var AddCard = function (a) {    return {ctor: "AddCard",_0: a};};
   var NoOp = {ctor: "NoOp"};
   return _elm.Deck.Action.values = {_op: _op,NoOp: NoOp,AddCard: AddCard,RemoveCard: RemoveCard,CardAdded: CardAdded,CardRemoved: CardRemoved};
};
Elm.Deck = Elm.Deck || {};
...
Elm.Deck.Update.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var removeFromList = F2(function (i,list) {
      var _p0 = i;
      if (_p0.ctor === "Just") {
            var _p1 = _p0._0;
            return A2($Basics._op["++"],A2($List.take,_p1,list),A2($List.drop,_p1 + 1,list));
         } else {
            return list;
         }
   });
      ...
      {case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         ...
         case "RemoveCard": var _p4 = _p2._0;
           return {ctor: "_Tuple2"
                  ...
                  ,_1: $Library$Util.actionEffect($Deck$Action.CardRemoved(_p4))};
         case "CardAdded": return {ctor: "_Tuple2",_0: model,_1: A2(services.signalCardAdded,_p2._0,$Deck$Action.NoOp)};
         default: return {ctor: "_Tuple2",_0: model,_1: A2(services.signalCardRemoved,_p2._0,$Deck$Action.NoOp)};}
   });
   var initialModelAndEffects = {ctor: "_Tuple2",_0: $Deck$Model.initialModel,_1: $Effects.none};
   var Services = F2(function (a,b) {    return {signalCardAdded: a,signalCardRemoved: b};});
...
Elm.Deck.Feature.make = function (_elm) {
   ...
   var createDeckFeature = function (config) {
      return $StartApp.start({init: $Deck$Update.initialModelAndEffects
                             ,update: $Deck$Update.update({signalCardAdded: $Library$Util.broadcast(config.outputs.onCardAdded)
                                                          ,signalCardRemoved: $Library$Util.broadcast(config.outputs.onCardRemoved)})
                             ,view: $Deck$View.view
                             ,inputs: config.inputs});
   };
   var Config = F2(function (a,b) {    return {inputs: a,outputs: b};});
...
Elm.DeckBuilderMain.make = function (_elm) {
   "use strict";
   _elm.DeckBuilderMain = _elm.DeckBuilderMain || {};
   if (_elm.DeckBuilderMain.values) return _elm.DeckBuilderMain.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $CardList$Action = Elm.CardList.Action.make(_elm),
   ...
   var deckFeature = $Deck$Feature.createDeckFeature({inputs: _U.list([deckMailbox.signal])
                                                     ,outputs: {onCardAdded: _U.list([A2($Signal.forwardTo,cardListMailbox.address,$CardList$Action.CardAdded)])
                                                               ,onCardRemoved: _U.list([A2($Signal.forwardTo,
                                                               cardListMailbox.address,
                                                               $CardList$Action.CardRemoved)])}});
   var html = A3($Signal.map2,deckBuilderMainView,cardListFeature.html,deckFeature.html);
   var tasks = $Signal.mergeMany(_U.list([cardListFeature.tasks,deckFeature.tasks]));
...
Elm.Main.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $DeckBuilderMain = Elm.DeckBuilderMain.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",$DeckBuilderMain.deckBuilderMainFeature.tasks);
   var main = $DeckBuilderMain.deckBuilderMainFeature.html;
